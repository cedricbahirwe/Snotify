...
extension SNShop {
    static let preview = SNShop(id: UUID().uuidString,
                                ...
                                profilePicture: nil,
                                location: nil,
                                description: "Friperies and vente d'habits en gros", metadata: [:])

    static let previews: [SNShop] = [
        SNShop(id: UUID().uuidString, name: "MA Eme", address: "Virunga, Depot No.000",
               profilePicture: nil, location: nil, description: "Vente de habits en gros", metadata: [:]),
        SNShop(id: UUID().uuidString, name: "Chez Da Eme", address: "Alanine, Depot No.101",
               profilePicture: nil, location: nil, description: "Meilleurs poissons de la ville", metadata: [:]),
        SNShop(id: UUID().uuidString, name: "Aristore Devices", address: "Grande barriere, en face de iHUSI hote",
               profilePicture: nil, location: nil, description: "iPhone, Macbook magasing", metadata: [:]),
        ...
        SNShop(id: UUID().uuidString, name: "La Beauté", address: "En face de l'hopital General",
               profilePicture: nil, location: nil, description: "Votre supermarché", metadata: [:])
    ]
}
